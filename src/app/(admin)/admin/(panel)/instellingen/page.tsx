    ...
    <div className="max-w-xl">
      ...
      <div className="mt-6 rounded-xl border border-ink/10 bg-white p-5 text-sm">
        ...
        <p className="mt-1 text-steel">
          ...
          Teksten, prijzen en diensten per taal in <code className="rounded bg-paper px-1.5 py-0.5 font-mono text-xs">src/i18n/nl.ts</code>, <code className="rounded bg-paper px-1.5 py-0.5 font-mono text-xs">en.ts</code> en <code className="rounded bg-paper px-1.5 py-0.5 font-mono text-xs">fr.ts</code>.
